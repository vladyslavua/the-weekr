...
class DayColumnItem extends Component {
	render() {
		...
		return (
			<div className={"button-no-decoration day-column__section " + (this.props.selectedDayTask ? 'day-column__section--active ' : '') + (this.props.hoverId === this.props.item.id ? 'day-column__section--hovered' : '')} tabindex="0">
