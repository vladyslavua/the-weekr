...
class DayColumnItem extends Component {
	render() {
		...
		return (
			<button className={"button-no-decoration day-column__section " + (this.props.selectedDayTask ? 'day-column__section--active ' : '') + (this.props.hoverId === this.props.item.id ? 'day-column__section--hovered' : '')}>
